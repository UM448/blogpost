...
<Stack gap={4} sx={{ mb: 2 }}>
                                        <Stack gap={1}>
                                            ...
                                            <Typography level="body-sm">
                                                Already a member?{' '}
                                                <Link to="/homesignin" level="title-sm" style={{ color: '#554994', fontWeight: 'bold', fontStyle: 'italic', textDecoration: 'none' }}>
                                                    Sign In!
                                                </Link>
                                            </Typography>
                                        </Stack>
                          ...
                          <div>
                            ...
                            >
                              ...
                              <Typography variant="body1" sx={{ color: '#fff', fontSize: '12px' }}>
                                Please{' '}
                                <Link to="/homesignin" style={{ color: '#554994', fontWeight: 'bold', fontStyle: 'italic', textDecoration: 'none' }}>
                                  Login
                                </Link> {' '}
                                yourself, if you are already a member! Or do register below,
                              </Typography>
                            ...
                            >
                              <Button variant="solid" color="primary" component={Link} to="/regblog" >
                                User Blog Sign-Up
                              </Button>
                            </Box>
                          </div>
                      ...
                      {showDashboardBox && (
                        ...
                        >
                          <div>
                            ...
                            >
                              <Button variant="solid" color="primary" component={Link} to="/reguser">
